    ...
    <div id="home" class="container tab-pane active"><br>
      <h3></h3>
          ...
          <div class="form-group">
            <label class="control-label lab col-sm-3" for="Id">ID:</label>
            <div class="col-sm-2">
            <input type="text" class="form-control" id="id"  name="id"  />
              ...
              <!-- <div class="form-group">
                ...
                <div class="col-sm-2"  data-provide="datepicker">
                  <input type="text" name="dob" style="color: black;" id="dob" name="dob" class="form-control" placeholder="Enter dob"  pattern="\d{4}-\d{2}-\d{2}"   oninvalid="setCustomValidity('Enter yyyy/mm/dd format')"  oninput="setCustomValidity('')"; > 
             ...
             <!--  <div class='col-md-6'>
               <div class="form-group">
                 <label class="control-label lab col-sm-6" for="dob">Dob</label>
       ...
       <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text"  style="color: black;" name="salary" id="salary"  class="form-control"placeholder="Enter salary" required onkeypress="return isNumberKey(event)" >
                </div>
              </div>
